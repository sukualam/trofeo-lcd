...
| `-k, --screenshot-key` | Global hotkey untuk menyimpan frame LCD sebagai tangkapan layar — **PNG lossless** (dikompres deflate, tetap identik piksel; layar flat ~10 KB, bukan 2,6 MB raw) (f1-f12, printscreen) | off |
