...
| `-k`, `--screenshot-key <KEY>` | Global hotkey to save a screenshot of the current LCD frame (f1-f12, `printscreen`). Lossless BMP files are saved to the `screenshots/` folder | off |
