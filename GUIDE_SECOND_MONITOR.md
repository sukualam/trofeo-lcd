...
| `-k`, `--screenshot-key <KEY>` | Global hotkey to save a screenshot of the current LCD frame (f1-f12, `printscreen`). Lossless PNG files (deflate-compressed — pixel-perfect but small) are saved to your **Desktop** | off |
