...
**Windows** — butuh driver USB WinUSB (via [Zadig](https://zadig.akeo.io/),
pastikan target driver = WinUSB). Untuk membaca suhu/power CPU AMD,
install [PawnIO](https://github.com/namazso/PawnIO) dan jalankan sebagai
Administrator.
